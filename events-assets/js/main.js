(function ($) {
	...
	=============================================*/
	function makeTimer() {
		var endTime = new Date("15 feb 2026 9:56:00 GMT+01:00");
		...
		if (days < 0) {
			...
			$(".event-btn").html("<span class=\"mr10 td-text d-inline-block mr-5 event-btn\" disabled>EVENT HAS ENDED</span>");
			$(".event-btn-arrow").css("display", "none");
			$(".event-btn-href").attr("href", "");
		} else {
